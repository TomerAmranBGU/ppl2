...
export const safe4 = <T1, T2, T3, T4, T5>(f: (a: T1, b: T2, c: T3, d: T4) => Result<T5>):
    (ar: Result<T1>, br: Result<T2>, cr: Result<T3>,dr: Result<T4>) => Result<T5> =>
        (ar: Result<T1>, br: Result<T2>, cr: Result<T3>, dr: Result<T4>) =>
            bind(ar, (a: T1) => bind(br, (b: T2) => bind(cr, (c: T3) =>bind(dr, (d: T4)=>  f(a,b,c,d)))));
